...
export function CountdownTimer({
    ...
    // When showSeconds is false (e.g. cramped mobile layouts), drop the
    // seconds unit entirely so it can't overlap adjacent elements.
    const units = showSeconds ? allUnits : allUnits.slice(0, 3);
