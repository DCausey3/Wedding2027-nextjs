...
const BRIDAL_PARTY: Member[] = [
    ...
    { name: 'David Green', role: 'Co-Best Man', side: 'groom', location: 'Gainesville,Florida', howTheyKnowUs: 'Best Friend Since 2nd Grade ' },
    { name: 'Ivan Cardenas', role: 'Groomsman', side: 'groom', location: 'Tampa, Florida', howTheyKnowUs: 'Bride Brother turned into a little brother to Groom' },
